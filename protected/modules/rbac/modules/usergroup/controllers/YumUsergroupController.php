...
class YumUsergroupController extends YumController {
	...
	public function actionWrite() {
		Yii::import('rbac.modules.usergroup.models.YumUsergroupMessage');
		...
		$this->redirect(array('//rbac/usergroup/groups/view',
					'id' => $message->group_id));
	...
	public function actionJoin($id = null) {
		if($id !== null) {
			...
			$this->redirect(array('//rbac/usergroup/groups/view', 'id' => $id));
		}
	}
