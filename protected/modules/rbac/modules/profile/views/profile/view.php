...
$this->renderPartial(
		'rbac.modules.friendship.views.friendship.friends', array(
			'model' => $model)); ?>
<br />
<?php
...
<?php
 if(!Yii::app()->user->isGuest && Yii::app()->user->id == $model->id) {
	echo CHtml::link(Yum::t('Edit profile'), array('//rbac/profile/profile/update'));
	echo '&nbsp;';
	echo CHtml::link(Yum::t('Upload avatar image'), array('//rbac/avatar/avatar/editAvatar'));
}
