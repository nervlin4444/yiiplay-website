...
Yii::import('rbac.modules.user.controllers.YumController');
class YumUserController extends YumController {
	...
	public function actionGenerateData() {
		if(Yum::hasModule('role'))
			Yii::import('rbac.modules.role.models.*');
	...
	public function actionLogin() {
		...
		if(Yii::app()->user->isGuest && Yii::app()->request->isAjaxRequest)
			return false;
		$this->redirect(array('//rbac/user/auth'));
	}

	public function actionLogout() {
		$this->redirect(array('//rbac/user/auth/logout'));
	}

	public function beforeAction($event) {
		if(!Yii::app()->user instanceof YumWebUser)
			throw new CException(Yum::t('Please make sure that Yii uses the YumWebUser component instead of CWebUser in your config/main.php components section. Most probably you forgot it. Please see the installation instructions.'));
	...
	public function actionProfile($id = null) {
		$this->redirect(array('//rbac/profile/profile/view',
	...
	public function actionUpdate() {
		...
		if(isset($_POST['YumUser'])) {
			...
			if(!$passwordform->hasErrors() && $model->save()) {
				...
				$this->redirect(array('//rbac/user/user/view', 'id' => $model->id));
			}
		}
	...
	public function actionDelete($id = null) {
		...
		if(Yii::app()->user->isAdmin()) {
			...
			if($user && ($user->id == Yii::app()->user->id)) {
				...
				$this->redirect(array('//rbac/user/user/admin'));
			}
