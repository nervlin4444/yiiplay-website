...
class UserModule extends CWebModule {
	...
	public $loginLayout = 'rbac.modules.user.views.layouts.yum';
	public $adminLayout = 'rbac.modules.user.views.layouts.yum';
  ...
  public $rteadapter = false; // Don't use an Adapter
	...
	private $_urls=array(
			'login'=>array('//rbac/user/user'),
			'return'=>array('//rbac/user/user/index'),
			'firstVisit'=>array('//rbac/user/privacy/update'),
			// Page to go after admin logs in
			'returnAdmin'=>false,
			// Page to go to after logout
			'returnLogout'=>array('//rbac/user/user/login'));
	...
	private $_views = array(
			...
			'messageCompose' =>'rbac.modules.message.views.message.compose');
