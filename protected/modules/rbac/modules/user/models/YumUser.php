...
class YumUser extends YumActiveRecord
{
	...
	public function behaviors()
	{
		return array(
				'CAdvancedArBehavior' => array(
					'class' => 'rbac.modules.user.components.CAdvancedArBehavior'));
	}
	...
	public function getActiveMemberships()
	{
		...
		Yii::import('rbac.modules.membership.models.*');
	...
	public function relations()
	{
		...
		if($relations === false) {
			...
			if (Yum::hasModule('messages')) {
				Yii::import('rbac.modules.message.models.*');
	...
	public function getFriends($everything = false)
	{
		...
		$friends = array();
		Yii::import('rbac.modules.friendship.models.YumFriendship');
				...
				if ($user->activationKey == $key) {
					...
					if ($user->save(false, array('activationKey', 'status'))) {
						...
						if (Yum::hasModule('messages')
							...
							Yii::import('rbac.modules.messages.models.YumMessage');
