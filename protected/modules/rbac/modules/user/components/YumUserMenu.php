		...
		return array(
				array('label' => 'Profile', 'visible' => Yum::hasModule('profile'), 'items' => array(
						array('label' => 'My profile', 'url' => array(
								'//rbac/profile/profile/view')),
						array('label' => 'Edit personal data', 'url' => array(
								'//rbac/profile/profile/update')),
						array(
				...
				array('label' => 'Messages',
					...
					'items' => array (
						array('label' => 'My inbox', 'url' => array('//rbac/message/message/index')),
				...
				array('label' => 'Social', 'items' => array(
							...
							array('label' => 'Browse users', 'url' => array('//rbac/user/user/browse')),
				...
				array('label' => 'Misc', 'items' => array(
							array('label' => 'Change password', 'url' => array('//rbac/user/user/changePassword')),
							array('label' => 'Delete account', 'url' => array('//rbac/user/user/delete')),
