	...
	<div class="time">
		<?php if($data->status==Comment::STATUS_PENDING): ?>
			...
			<?php echo CHtml::linkButton('Approve', array(
				'submit'=>array('blog/comment/approve','id'=>$data->id),
			)); ?> |
		<?php endif; ?>
		<?php echo CHtml::link('Update',array('blog/comment/update','id'=>$data->id)); ?> |
		<?php echo CHtml::linkButton('Delete', array(
			'submit'=>array('blog/comment/delete','id'=>$data->id),
